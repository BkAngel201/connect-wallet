...
function NavBar({ setOpenConnectModal, disconnectFromWallet, connectedAccount, walletConnected, openSideMenu, setOpenSideMenu, verifyConnectionToWallet, sendVerificationSignatureToWallet, globalSignature, connectionVerified }) {
