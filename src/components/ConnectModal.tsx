                    ...
                    !walletSelected ?
                        ...
                        <div className="flex flex-col justify-center items-center mt-4 relative h-full">
                            ...
                            <div className="grow relative">
                                <img className="w-64 opacity-40" src={walletSelected.icon} alt="Wallet Icon Background"/>
                                {
                                    connectionMessage &&
